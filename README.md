...
<img src="https://skillicons.dev/icons?i=react,nodejs,ts,js,express,mongodb,html,css,tailwind,git,github,vscode,postman,npm&perline=7" alt="stack" />
...
| ---------------------- | --------------------------------------- | -------------------------------- | ------------ |
| Monqez                 | Graduation project — [add description]  | React, Node.js, MongoDB, Express | ✅ Completed |
| Forever                | E-commerce platform for ITI scholarship | React, Node.js, MongoDB, Express | ✅ Completed |
| Prescripto-Medical-App | Medical application — [add description] | React, Node.js, MongoDB, Express | ✅ Completed |
